...

{
  ...
  programs.zsh = {
    ...
    shellAliases = {
      # Nix aliases - using absolute paths for maximum reliability
      nixrebuild = "/Users/jacksonmiller/nix-config/scripts/rebuild.sh";
    ...
    initExtra = ''
      ...
      nixrebuild() {
        /Users/jacksonmiller/nix-config/scripts/rebuild.sh "$@"
      }
